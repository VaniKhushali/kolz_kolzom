...
<head>
   ...
   <link rel="icon" href="{{ static_asset('assets/img1/logo.jpg') }}"type="image/x-icon"> 
    <title>Kolzom || Home</title>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.0.0/flowbite.min.css" rel="stylesheet" />
  
<script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.0.0/flowbite.min.js"></script>
</head>
<body>
<nav class="bg-white dark:bg-gray-900 fixed   w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600 grid-cols-[200px_minmax(900px,_1fr)_100px]">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
  <a href="#" class="flex items-center">
      <img src="#" class="h-8 mr-3" alt="">
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">
<img class="h-auto" src="{{ static_asset('assets/img1/logo.jpg') }}" alt="image description" style="width:200px;">
</span>
  </a>
  <div class="flex md:order-2 space-x-3" >
      
      <a href="{{ route('shops.create') }}"><button type="button"  class="text-white mt-3 bg-blue-500 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300  h-10 w-35 rounded-full text-lg px-8 py-2 text-center mr-3 md:mr-0 dark:bg-blue-500 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Start Selling</button></a>
<div class="flex flex-col" >

     <a href="{{ route('shops.create') }}"><button type="button"  class="text-white mt-3 bg-blue-500  hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300  h-10 w-35 rounded-full text-lg px-8 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button></a>
</div>    
  </div>
  </div>
</nav>

<section class=" bg-no-repeat" style="background-image:url('{{ static_asset('assets/img1/banner4.jpg') }}');height:500px;background-size: 100% 500px;">

    <div class="px-4 mx-auto max-w-screen-xl  py-24 lg:py-56">
        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-xl">LIMITED TIME MEGA OFFER</h1>
        <p class="mb-4 text-lg font-bold text-white  lg:text-5xl">Become an Kolzom Seller</p>
        <span class="text-lg text-black hover:text-blue-800 ml-2 cursor-pointer ">Sell to crores of customers with 50% off on selling fee</span>
        <div class="flex flex-col space-y-5 sm:flex-row  sm:space-y-0 sm:space-x-5">
            <a href="{{ route('shops.create') }}" class="inline-flex   py-3 px-5 text-3xl font-medium text-center text-white rounded-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                Start Selling
...
<p class=" flex mb-4 text-4xl items-center justify-center font-bold text-gray-500 ">How to sell on Kolzom </p>
<div class=" flex flex-col grid mb-8 border items-center justify-center  rounded-lg shadow-xl  md:mb-12 md:grid-cols-2  grid-cols-[200px_minmax(900px,_1fr)_100px]" style="width:80%;margin-left:120px;">
    <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-800 dark:border-gray-700">
        
        <figcaption class="flex items-center justify-center space-x-3">
            <img class="rounded-full " style="width:150px;height:150px;" src="{{ static_asset('assets/img1/regi.jpg') }}" alt="profile picture">
            <div class="space-y-0.5 font-medium dark:text-white text-left">
                <div>STEP 1: Register your account</div>
                <div class="text-sm text-gray-500 dark:text-gray-400">Register on Kolzom with details and an active bank account</div>
            </div>
        </figcaption>    
    </figure>
    <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-tr-lg dark:bg-gray-800 dark:border-gray-700">
        ...
        <figcaption class="flex items-center justify-center space-x-3">
            <img class="rounded-full" style="width:150px;height:150px;" src="{{ static_asset('assets/img1/stsh.jpg') }}" alt="profile picture">
            <div class="space-y-0.5 font-medium dark:text-white text-left">
                <div>STEP 2: Choose storage & shipping</div>
                <div class="text-sm text-gray-500 dark:text-gray-400">Choose storage, packaging, and delivery options</div>
            </div>
        </figcaption>    
    </figure>
    <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-bl-lg md:border-b-0 md:border-r dark:bg-gray-800 dark:border-gray-700">
        ...
        <figcaption class="flex items-center justify-center space-x-3">
            <img class="rounded-full" style="width:150px;height:150px;" src="{{ static_asset('assets/img1/lipr.jpg') }}" alt="profile picture">
            <div class="space-y-0.5 font-medium dark:text-white text-left">
                <div>STEP 3: List your products</div>
                <div class="text-sm text-gray-500 dark:text-gray-400">List your products by providing product and brand details</div>
            </div>
        </figcaption> 
        <a href="{{ route('shops.create') }}"><button type="button" style="background-color:#fd5417;font-size:20px;width:200px; margin:30px;" class="text-white mt-3 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300   rounded-full text-lg px-8 py-2 text-center mr-3 md:mr-0 dark:bg-blue-500 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Start Selling</button></a>   
    </figure>
    <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-gray-200 rounded-b-lg md:rounded-br-lg dark:bg-gray-800 dark:border-gray-700">
        ...
        <figcaption class="flex items-center justify-center space-x-3">
            <img class="rounded-full" style="width:150px;height:150px;" src="{{ static_asset('assets/img1/comp.jpg') }}" alt="profile picture">
            <div class="space-y-0.5 font-medium dark:text-white text-left">
                <div>STEP 4: Complete orders & get paid</div>
                <div class="text-sm text-gray-500 dark:text-gray-400">Deliver orders to customers on time and get paid within 7 days of delivery</div>
            </div>
            
        </figcaption>   
        <a href="{{ route('shops.create') }}"><button type="button" style="background-color:#fd5417;font-size:20px;width:300px; margin:30px;" class="text-white mt-3 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300   rounded-full text-lg px-8 py-2 text-center mr-3 md:mr-0 dark:bg-blue-500 dark:hover:bg-blue-700 dark:focus:ring-blue-800">How to register as a seller</button></a> 
    </figure>
...
<p class=" flex mb-4 text-4xl items-center justify-center font-bold text-gray-500 ">Why become a seller on Kolzom?</p>
<div class="p-3 grid grid-cols-3 gap-5 " style="margin:40px;">
<div class="bg-slate-300 border rounded-lg shadow-xl grid-cols-[200px_minmax(900px,_1fr)_100px]" style="padding:20px;">

    <a href="#">
        <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Crores of customers</h5>
    </a>
    <hr style="background-color:blue;height:3px;">
    <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Reach crores of customers on Kolzom, India's most visited shopping destination</p>
</div>
<div class="bg-slate-300 rounded-lg shadow-xl" style="padding:20px;">
    <a href="#">
        <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">18,000 crorepati sellers</h5>
    </a>
    <hr style="background-color:blue;height:3px;">
    <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">5,100 new crorepati sellers in 2022 alone. You could be next.</p>
</div>
    <div class="bg-slate-300 rounded-lg shadow-xl" style="padding:20px;">
    <a href="#">
        <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Unbeatable Reach</h5>
    </a>
    <hr style="background-color:blue;height:3px;">
    <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Deliver to 100% of India's serviceable pincodes, through Easy Ship & Fulfillment by Kolzom.</p>
</div>
</div>
<!-- testimonial -->
<link
...
<div class="bg-no-repeat bg-cover bg-center relative" style="background-image: url(https://images.unsplash.com/photo-1606938704652-3e588c2c9fd4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1964&q=80);height:550px;">
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    <!-- end testimonial -->
  <video class="w-full" autoplay muted controls style="height:400px;">
  <source src="{{ static_asset('assets/video/add.mp4') }}" type="video/mp4">
  Your browser does not support the video tag.
</video>
<!-- accordion -->
<hr style="background-color:gray;height:2px; margin:30px;">
<p class=" flex mb-4 text-4xl items-center justify-center font-bold text-gray-500 ">Frequently Asked Questions</p>
<div id="accordion-collapse" data-accordion="collapse" style="margin:40px;">
  <h2 id="accordion-collapse-heading-1">
    <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800" data-accordion-target="#accordion-collapse-body-1" aria-expanded="true" aria-controls="accordion-collapse-body-1">
      <span>How do I sell on Kolzom?</span>
  ...
  <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
      <p class="mb-2 text-gray-500 dark:text-gray-400">To sell on Kolzom, you need to create a seller account. You will require details and an active bank account to register as a seller. Enter your business details, select shipment method and list your products to launch your store on Kolzom.</p>
      
    </div>
  </div>
  <h2 id="accordion-collapse-heading-2">
    <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800" data-accordion-target="#accordion-collapse-body-2" aria-expanded="false" aria-controls="accordion-collapse-body-2">
      <span>What are the requirements to start selling on Kolzom?</span>
      <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
      </svg>
    </button>
  ...
  <div id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
      <p class="mb-2 text-gray-500 dark:text-gray-400">You require active bank account to register as a seller. You should also have your email and phone handy for account verification through OTP.</p>
      
    </div>
  </div>
  <h2 id="accordion-collapse-heading-3">
    <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800" data-accordion-target="#accordion-collapse-body-3" aria-expanded="false" aria-controls="accordion-collapse-body-3">
      <span>How to create a seller account on Kolzom?</span>
      <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
      </svg>
    </button>
  ...
  <div id="accordion-collapse-body-3" class="hidden" aria-labelledby="accordion-collapse-heading-3">
    <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
      <p class="mb-2 text-gray-500 dark:text-gray-400">To begin creating a seller account on Kolzom, 'Start Selling' button. If you already have an account on Kolzom, you can login with the same credentials. Otherwise, select 'Create New Account' option and start registering with your email and mobile number.</p>
...
<!-- end accordion -->
<section class=" bg-no-repeat" style="background-image:url('{{ static_asset('assets/img1/footer.jpg') }}');height:500px;background-size: 100% 500px;">

    <div class="px-4 mx-auto max-w-screen-xl  py-24 lg:py-56">
                <p class="mb-4 text-lg font-bold text-black  lg:text-4xl">Start your Kolzom seller journey</p>
        <span class="text-lg text-black hover:text-blue-800 ml-2 cursor-pointer ">Join our family of 12 Lakh+ businesses who sell on Kolzom</span>
        <div class="flex flex-col space-y-5 sm:flex-row  sm:space-y-0 sm:space-x-5">
            <a href="#" class="inline-flex   py-3 px-5 text-3xl font-medium text-center text-white rounded-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                Start Selling
...
<footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" class="hover:underline">Kolzom™</a>. All Rights Reserved.
          </span>
