        ...
        <div class="row">
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            ...
                            <a href="{{ $widget_one_links }}" class="fs-13 text-soft-light  ">
            ...
            <div class="{{ $col_values }}">
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <h4 class="fs-14  text-uppercase fw-700 mb-3" style="color:#fff;">
                        ...
                        {{ get_setting('widget_two',null,App::getLocale()) }}
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            ...
                            <a href="{{ $widget_two_links }}" class="fs-13 text-soft-light  ">
            ...
            <div class="{{ $col_values }}">
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <h4 class="fs-14  text-uppercase fw-700 mb-3" style="color:#fff;">
                        ...
                        {{ get_setting('widget_three',null,App::getLocale()) }}

                    </h4>

                    <ul class="list-unstyled">

                        @if ( get_setting('widget_three_labels',null,App::getLocale()) != null )

                        @foreach (json_decode( get_setting('widget_three_labels',null,App::getLocale()), true) as $key => $value)
                        ...
                        <li class="mb-2">
                            ...
                            <a href="{{ $widget_three_links }}" class="fs-13 text-soft-light  ">
            ...
            <div class="{{ $col_values }}">
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <h5 class="fs-14 fw-700  text-uppercase mt-3" style="color:#fff;">{{ translate('Mobile Apps') }}</h5>
                    ...
                    <!--             <a class="fs-13 text-soft-light  " href="{{ route('logout') }}">-->
                    ...
                    <!--             <a class="fs-13 text-soft-light  " href="{{ route('user.login') }}">-->
                    ...
                    <!--         <a class="fs-13 text-soft-light  " href="{{ route('purchase_history.index') }}">-->
                    ...
                    <!--         <a class="fs-13 text-soft-light  " href="{{ route('wishlists.index') }}">-->
                    ...
                    <!--         <a class="fs-13 text-soft-light  " href="{{ route('orders.track') }}">-->
                    ...
                    <!--             <a class="fs-13 text-soft-light  " href="{{ route('affiliate.apply') }}">-->
                    ...
                    <!--                 <a class="fs-13 text-soft-light  " href="{{ route('seller.login') }}">-->
                    ...
                    <!--                 <a class="fs-13 text-soft-light  " target="_blank" href="{{ get_setting('seller_app_link')}}">-->
                ...
                <div class="text-center text-sm-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                            ...
                            <a class="fs-13 text-soft-light  " href="{{ route('deliveryboy.login') }}">
                        ...
                        <li class="mb-2">
                            ...
                            <a class="fs-13 text-soft-light  " target="_blank" href="{{ get_setting('delivery_boy_app_link')}}">
                ...
                <div class="container">
                    ...
                    <ul class="list-unstyled mt-3">
                        ...
                        <li class="mb-2 pb-2 @if (url()->current() == $widget_one_links) active @endif">
                            ...
                            <a href="{{ $widget_one_links }}" class="fs-13 text-soft-light text-sm-secondary  ">
                ...
                <div class="container">
                    ...
                    <ul class="list-unstyled mt-3">
                        ...
                        <li class="mb-2 pb-2">
                            ...
                            <a class="fs-13 text-soft-light text-sm-secondary  " href="{{ route('logout') }}">
                        ...
                        <li class="mb-2 pb-2 {{ areActiveRoutes(['user.login'],' active')}}">
                            ...
                            <a class="fs-13 text-soft-light text-sm-secondary  " href="{{ route('user.login') }}">
                        ...
                        <li class="mb-2 pb-2 {{ areActiveRoutes(['purchase_history.index'],' active')}}">
                            ...
                            <a class="fs-13 text-soft-light text-sm-secondary  " href="{{ route('purchase_history.index') }}">
                        ...
                        <li class="mb-2 pb-2 {{ areActiveRoutes(['wishlists.index'],' active')}}">
                            ...
                            <a class="fs-13 text-soft-light text-sm-secondary  " href="{{ route('wishlists.index') }}">
                        ...
                        <li class="mb-2 pb-2 {{ areActiveRoutes(['orders.track'],' active')}}">
                            ...
                            <a class="fs-13 text-soft-light text-sm-secondary  " href="{{ route('orders.track') }}">
                        ...
                        <li class="mb-2 pb-2 {{ areActiveRoutes(['affiliate.apply'],' active')}}">
                            ...
                            <a class="fs-13 text-soft-light text-sm-secondary  " href="{{ route('affiliate.apply') }}">
                ...
                <div class="container">
                    ...
                    <ul class="list-unstyled mt-3">
                        ...
                        <li class="mb-2 pb-2 {{ areActiveRoutes(['deliveryboy.login'],' active')}}">
                            ...
                            <a class="fs-13 text-soft-light text-sm-secondary  " href="{{ route('seller.login') }}">
                        ...
                        <li class="mb-2 pb-2">
                            ...
                            <a class="fs-13 text-soft-light text-sm-secondary  " target="_blank" href="{{ get_setting('seller_app_link')}}">
                ...
                <div class="container">
                    ...
                    <ul class="list-unstyled mt-3">
                        ...
                        <li class="mb-2 pb-2 {{ areActiveRoutes(['deliveryboy.login'],' active')}}">
                            ...
                            <a class="fs-13 text-soft-light text-sm-secondary  " href="{{ route('deliveryboy.login') }}">
                        ...
                        <li class="mb-2 pb-2">
                            ...
                            <a class="fs-13 text-soft-light text-sm-secondary  " target="_blank" href="{{ get_setting('delivery_boy_app_link')}}">
    ...
    <div class="container">
        ...
        <div class="row align-items-center py-3">
            ...
            <div class="col-lg-12 order-1 order-lg-0">
                ...
                <div class="text-center  fs-14" current-verison="{{get_setting("current_version")}}">
