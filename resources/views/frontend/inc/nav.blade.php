 ...
 *+ul{
    ...
    <header class="@if (get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 " style="background: #0074fd;">
       	<!--  <div class="position-relative logo-bar-area border-bottom border-md-nonea z-1025" >
            <div class="container-fluid">
              ...
              <a href="{{ route('seller.login') }}"
                                    class="text-reset  fs-12 d-inline-block py-2 pl-2" style="color:#fff !important;">{{  translate('Beome a Seller') }}</a>
 </div>
             </div>
              </div>
         </div> -->
            ...
            <div class="container" style="height:80%;">
                <div class="d-flex align-items-center">
                    ...
                    <div class="ml-auto mr-0">
                        ...
                        ?>
                            <span
                                class="user-hover d-none d-xl-flex align-items-center nav-user-info py-20px @if (isAdmin()) ml-5 @endif"
                                id="nav-user-info">
                                <!-- Image -->
                                <span
  ...
  <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664z"/>
                                ...
                                <a href="{{ route('user.login') }}"
                                    class="text-reset  fs-12 d-inline-block  border-soft-light border-width-2" style="color:#fff !important;">{{ translate('Login') }}</a>
                    ...
                    <div class="ml-auto mr-0 ">
                        ...
                        ?>
                            <span
                                class="seller-hover d-none d-xl-flex align-items-center nav-user-info py-20px @if (isAdmin()) ml-5 @endif"
                                id="nav-user-info1">
                                <!-- Image -->
                                <span
                                    class="size-40px rounded-circle overflow-hidden border border-transparent nav-user-img">
        ...
        <div class="collapse-sidebar c-scrollbar-light text-left">
            ...
            @else
                ...
                <span class="d-flex align-items-center nav-user-info pl-4" >
                    ...
                    <a href="{{ route('user.login') }}"
                        class="text-reset opacity-60 hov-opacity-100  hov-text-white fs-12 d-inline-block border-right border-soft-light border-width-2 pr-2 ml-3">{{ translate('Login') }}</a>
                    <a href="{{ route('user.registration') }}"
                        class="text-reset opacity-60 hov-opacity-100 hov-text-white fs-12 d-inline-block py-2 pl-2">{{ translate('Registration') }}</a>
                </span>
            @endauth
            <hr>
