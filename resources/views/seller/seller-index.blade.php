...
<img class="h-auto" src="img/logo.jpg" alt="image description" style="width:200px;">
</span>
  </a>
  <div class="flex md:order-2 space-x-3" >
      
      <a href="login"><button type="button"  class="text-white mt-3 bg-blue-500 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300  h-10 w-35 rounded-full text-lg px-8 py-2 text-center mr-3 md:mr-0 dark:bg-blue-500 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Start Selling</button></a>
<div class="flex flex-col" >

     <a href="login"><button type="button"  class="text-white mt-3 bg-blue-500  hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300  h-10 w-35 rounded-full text-lg px-8 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button></a>
</div>    
  </div>
  </div>
</nav>

<section class=" bg-no-repeat" style="background-image:url('img/banner4.jpg');height:500px;background-size: 100% 500px;">
    ...
    <div class="px-4 mx-auto max-w-screen-xl  py-24 lg:py-56">
        ...
        <div class="flex flex-col space-y-5 sm:flex-row  sm:space-y-0 sm:space-x-5">
            <a href="login" class="inline-flex   py-3 px-5 text-3xl font-medium text-center text-white rounded-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                Start Selling
...
<div class=" flex flex-col grid mb-8 border items-center justify-center  rounded-lg shadow-xl  md:mb-12 md:grid-cols-2" style="width:80%;margin-left:150px;">
    <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-800 dark:border-gray-700">
        
        <figcaption class="flex items-center justify-center space-x-3">
            <img class="rounded-full " style="width:150px;height:150px;" src="img/regi.jpg" alt="profile picture">
    ...
    <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-tr-lg dark:bg-gray-800 dark:border-gray-700">
        ...
        <figcaption class="flex items-center justify-center space-x-3">
            <img class="rounded-full" style="width:150px;height:150px;" src="img/stsh.jpg" alt="profile picture">
            <div class="space-y-0.5 font-medium dark:text-white text-left">
    ...
    <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-bl-lg md:border-b-0 md:border-r dark:bg-gray-800 dark:border-gray-700">
        ...
        <figcaption class="flex items-center justify-center space-x-3">
            <img class="rounded-full" style="width:150px;height:150px;" src="img/lipr.jpg" alt="profile picture">
            <div class="space-y-0.5 font-medium dark:text-white text-left">
    ...
    <figure class="flex flex-col items-center justify-center p-8 text-center bg-white border-gray-200 rounded-b-lg md:rounded-br-lg dark:bg-gray-800 dark:border-gray-700">
        ...
        <figcaption class="flex items-center justify-center space-x-3">
            <img class="rounded-full" style="width:150px;height:150px;" src="img/comp.jpg" alt="profile picture">
            <div class="space-y-0.5 font-medium dark:text-white text-left">
...
<div class="bg-slate-300 border rounded-lg shadow-xl " style="padding:20px;">
...
<!-- end accordion -->
<section class=" bg-no-repeat" style="background-image:url('img/footer.jpg');height:500px;background-size: 100% 500px;">
        ...
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="#" class="flex items-center">
                  ...
                  <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white"><img class="h-auto" src="img/logo.jpg" alt="image description" style="width:200px;"></span>
              </a>
          </div>
