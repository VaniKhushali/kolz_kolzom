                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz- category_id" name="category_id" 
                                   required>
                                ...
                                <select class="form-control aiz- sub_category_id" name="sub_category_id" 
                                     required>
                                     
                                </select>
                                <select class="form-control aiz- child_category_id" name="child_category_id" 
                                     required>
...
@section('script')
    <script type="text/javascript">
        ...
        $(function(){
            $(".category_id").on("change", function() { 
                ...
                if(category_id){
                    $.ajax({
                        ...
                        type: "POST",
                        dataType:"json",
                        url: '{{ route('seller.products.get-subcategory') }}',
                        data: {
                            category_id
                        },
            ...
            $(".child_category_id").hide();
            $(".sub_category_id").on("change", function() { 
                var ts = $(this);
                var category_id = ts.val(); 
                var parent_id = ts.find('option:selected').attr("parent_id"); 
                console.log("-parent_id",parent_id)
                if(parent_id > 0){
                    $(".child_category_id").show();
                    $.ajax({
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
            ...
            $(".child_category_id").on("change", function() { 
                ...
                if(id > 0){
                    $.ajax({
                        ...
                        type: "POST",
                        dataType:"json",
                        url: '{{ route('seller.products.get-category-related') }}',
                        data: {
                            category_id: id
                        },
                        success: function(data) {
