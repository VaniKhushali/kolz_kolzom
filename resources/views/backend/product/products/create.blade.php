                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="pname" class="form-control" name="name" placeholder="{{ translate('Product Name') }}" onchange="update_sku()" required>
                            </div>
                        </div>
                      
                      <div class="recommendedContent">
                        <div class="recommendedTitleStyle">Recommend Category</div>
                        <div class="recommendedValueContent">
                          <div class="recommendedValueOptionContent flexCenterLeft" data-spm-anchor-id="0.0.0.i1.2b417463yEfS39">
                            <input placeholder="please input" class="recommendedValueOptionRadioStyle" type="radio" data-emogine-form-component-dom-type="area" data-emogine-form-component-id="1g5ti081">
                            <div class="recommendedValueOptionStyle">
                              Media, Music &amp; Books&gt;Books&gt;Local Books&gt;Literature
                           	</div>
                          </div>
                          <div class="recommendedValueOptionContent flexCenterLeft" data-spm-anchor-id="0.0.0.i2.2b417463yEfS39">
                            <input placeholder="please input" class="recommendedValueOptionRadioStyle" type="radio" data-emogine-form-component-dom-type="area" data-emogine-form-component-id="aurf998n">
                            <div class="recommendedValueOptionStyle">
                              Media, Music &amp; Books&gt;Books&gt;English Books&gt;Literature
                            </div>
                          </div>
                        </div>
                      	</div>
...
<script type="text/javascript">
  ...
  $('#pname').on('input', function() {
    var url = "{{ route('recommend_categories') }}";
  	$.ajax({
            url: url,
            type: 'GET',
        ...
        function displayCategories(categories) {
            ...
            $.each(categories, function (index, category) {
                var categoryString = category.title;

                $.each(category.subcategories, function (index, subcategory) {
                    var subcategoryString = categoryString + '>' + subcategory.title;

                    $.each(subcategory.child_categories, function (index, childCategory) {
                        var childCategoryString = subcategoryString + '>' + childCategory.title;
                        categoryList.append('<p>' + childCategoryString + '</p>');
                    });
                });
            });
        }
