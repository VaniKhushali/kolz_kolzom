                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endif
                             @can('view_all_support_tickets')
                                ...
                                @endphp
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('customer_support_ticket.admin_index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customer_support_ticket.admin_index', 'customer_support_ticket.admin_show'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Customers Ticket')}}</span>
                           ...
                           @can('view_all_support_tickets')
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('support_ticket.admin_index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['support_ticket.admin_index', 'support_ticket.admin_show'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Sellers Ticket')}}</span>
                                        @if($support_ticket > 0)<span class="badge badge-info">{{ $support_ticket }}</span>@endif
                                    </a>
                                </li>
                            @endcan
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            @can('view_all_support_tickets')
                                ...
                                @endphp
                                <li class="aiz-side-nav-item"> 
                                    <a href="{{ route('support_tickets.admins_index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['support_tickets.admins_index', 'support_ticket.admin_show'])}}">
