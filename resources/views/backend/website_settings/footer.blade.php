    									...
    									@if (get_setting('widget_two_labels',null,$lang) != null)
    										@foreach (json_decode(get_setting('widget_two_labels',null,$lang), true) as $key => $value)
    											...
    											<div class="row gutters-5">
    												...
    												<div class="col">
    													<div class="form-group">
    														<input type="text" class="form-control" placeholder="http://" name="widget_two_links[]" value="{{ $widget_two_links }}">
    													</div>
    												</div>
    												<div class="col-auto">
    													<button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
    					...
    					<div class="card-body">
                            <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    							...
    							<div class="form-group">
    								...
    								<input type="text" class="form-control" placeholder="Widget title" name="widget_three" value="{{ get_setting('widget_three',null,$lang) }}">
    							</div>
								<!-- Links -->
    			                <div class="form-group">
    								<!--<label>{{ translate('Links') }} - ({{ translate('Translatable') }} {{ translate('Label') }})</label>-->
    								<div class="w3-links-target3">
    									<input type="hidden" name="types[][{{ $lang }}]" value="widget_three_labels">
    									<input type="hidden" name="types[]" value="widget_three_links">
    									@if (get_setting('widget_three_labels',null,$lang) != null)
    										@foreach (json_decode(get_setting('widget_three_labels',null,$lang), true) as $key => $value)
    											...
    											<div class="row gutters-5">
    												...
    												<div class="col">
    													<div class="form-group">
    														<input type="text" class="form-control" placeholder="http://" name="widget_three_links[]" value="{{ $widget_three_links }}">
    													</div>
    												</div>
    												<div class="col-auto">
    													<button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
