...
class ProductController extends Controller
{
    ...
    public function getSubcategory(Request $request)
    {
        ...
        foreach ($categories as $row) {
            $html .= '<option value="' . $row->id . '" parent_id="' . $row->parent_id . '">' . $row->name . '</option>';
        }

        echo json_encode($html);
    }

    public function getCategoryRelated(Request $request)
    {
        try{
            $attCategories = AttributeCategory::with('attributes')->where('category_id', $request->category_id)->get();
            // print_r($attCategories);
            foreach ($attCategories as $key => $value) {
                $attVal = AttributeValue::where('attribute_id', $value->attribute_id)->get();
                // print_r($attVal);
                $value['catval'] = $attVal;
            }
        ...
        // echo json_encode($attCategories);
        // Render the view and pass attribute values
        $html = View::make('seller.product.products.attributes_view', ['values' => $attCategories])->render();
