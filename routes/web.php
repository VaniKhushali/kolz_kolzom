...
Route::post('/seller/login', 'login')->name('seller.login.submit');

    Route::get('/seller/login', 'showLoginForm')->name('seller.login');
...
Route::get('/sellercentre/seller-index', function () {

    return view('frontend/raj');

});

Route::get('/sellercentre/seller', function () {

    return view('sellercentre/seller');

});

Route::post('/sellercentre/register',[SellerRegisetrController::class, 'store']);



  Route::get('/sellercentre/welcome', function () {

    return view('sellercentre/welcome');
