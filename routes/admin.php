...
use App\Http\Controllers\SellerTicketController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function() {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::get('/products/create', 'create')->name('products.create');
      	Route::get('/products/recommend-category','recommend_categories')->name('recommend_categories');
    ...
    Route::controller(SupportTicketController::class)->group(function () {
        ...
        Route::get('support_tickets/', 'admins_index')->name('support_tickets.admins_index');
 	...
 	Route::controller(CustomerTicketController::class)->group(function () {
        Route::get('customer_support_ticket/', 'admin_index')->name('customer_support_ticket.admin_index');
        Route::get('customer_support_ticket/{id}/show', 'admin_show')->name('customer_support_ticket.admin_show');
        Route::post('customer_support_ticket/reply', 'admin_store')->name('customer_support_ticket.admin_store');
    });
