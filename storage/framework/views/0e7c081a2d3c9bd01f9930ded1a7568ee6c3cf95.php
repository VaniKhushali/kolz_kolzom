                                ...
                                <div class="carousel-box">
                                    <a href="<?php echo e(json_decode(get_setting('home_slider_links'), true)[$key]); ?>">
                                        ...
                                        <img class="d-block mw-100 img-fit overflow-hidden h-sm-auto  h-md-350px overflow-hidden"
                                            ...
                                            onerror="this.onerror=null;this.src='<?php echo e(static_asset('assets/img/placeholder-rect.jpg')); ?>';" style="border-radius:20px;width:100%;">
        ...
        <div class="container">
            ...
            <div class="d-flex flex-wrap mb-2 mb-md-3 align-items-baseline justify-content-between">
                ...
                <div>
                    <div class="text-dark d-flex align-items-center mb-0">
                        <a href="<?php echo e(route('flash-deals')); ?>" class="fs-10 fs-md-12 fw-700 text-reset has-transition opacity-60 hov-opacity-100 hov-text-primary  mr-3"><?php echo e(translate('View All Flash Sale')); ?></a>
                        <span class=" border-left border-soft-light border-width-2 pl-3">
                            <a href="<?php echo e(route('flash-deal-details', $flash_deal->slug)); ?>" class="fs-10 fs-md-12 fw-700 text-reset has-transition opacity-60 hov-opacity-100 hov-text-primary"><?php echo e(translate('View All Products from This Flash Sale')); ?></a>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="row gutters-5 gutters-md-16">
                ...
                <div class="col-xxl-4 col-lg-5 col-6 h-200px h-md-400px h-lg-475px">
                    ...
                    <div class="h-100 w-100 w-xl-auto" style="background-image: url('<?php echo e(uploaded_asset($flash_deal->banner)); ?>'); background-size: cover; background-position: center;">
                                    ...
                                    <?php if($product != null && $product->published != 0): ?>
                                        ...
                                        <div class="h-100px h-md-200px h-lg-auto flash-deal-item position-relative text-center border-bottom <?php if($i!=4): ?> border-right <?php endif; ?> has-transition hov-shadow-out z-1">
                                            <a href="<?php echo e($product_url); ?>" class="d-block py-md-3 overflow-hidden hov-scale-img" title="<?php echo e($product->getTranslation('name')); ?>">
                                                ...
                                                <img src="<?php echo e($product->thumbnail != null ? my_asset($product->thumbnail->file_name) : static_asset('assets/img/placeholder.jpg')); ?>" class="lazyload h-60px h-md-100px h-lg-140px mw-100 mx-auto has-transition"
    ...
    <?php if(count($featured_categories) > 0): ?>
        <section class="" >
            <div class="container" >
                ...
                <!--            <span class=""><?php echo e(translate('Featured Category')); ?></span>-->
                <!--        </h3>-->
                        <!-- Links -->
                ...
                <div class="bg-white">
                    ...
                    <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between" style="background-color:#EEEEEE;">
                        ...
                        <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0" style="margin-left:-2.5rem;margin-top:-1rem;">
                            <span class=""><?php echo e(translate('Flash Sale')); ?></span>
                        </h3>
                        <!-- Links -->
                    </div>
                </div>
                ...
                <div class="px-sm-3" style="margin-left:-2.5rem;margin-top:-2.3rem;margin-right:-3.6rem;">
                    <div class="aiz-carousel sm-gutters-17"  data-items="8" data-xxl-items="8" data-xl-items="6" data-lg-items="5" data-md-items="4" data-sm-items="3" data-xs-items="2" data-arrows="true" data-dots="false" data-autoplay="true" data-infinite="true">
                        <?php $__currentLoopData = $featured_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div id="as" class="bg-white carousel-box position-relative text-center has-transition hov-scale-img  border-right border-top border-bottom <?php if($key == 0): ?> border-left <?php endif; ?>" style="width:95% !important;">
                                ...
                                <h6 class="text-dark mb-3 h-40px text-truncate-2">
                                    <a class="text-reset fw-700 fs-14 hov-text-black" href="<?php echo e(route('products.category', $category->slug)); ?>" title="<?php echo e($category->getTranslation('name')); ?>"><?php echo e($category->getTranslation('name')); ?></a><br />
                              <span class="fw-700 text-black"><?php echo e(single_price($category->unit_price)); ?></span> 
                              </h6>
                ...
                <div class="bg-white">
                    ...
                    <div class="d-flex align-items-baseline justify-content-between" style="background-color:#EEEEEE;" >
                        ...
                        <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0" style="margin-left:-2.5rem;">
                            <span class=""><?php echo e(translate('Category')); ?></span>
                        </h3>
                        <!-- Links -->
...
.uk-card-default.uk-card-hover:hover {
  ...
  <!--                  <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between" style="background-color:#EEEEEE;">-->
                        <!-- Title -->
  <!--                      <h3 class="fs-16 fs-md-20 fw-700 mb-2 mb-sm-0" style="margin-left:-2.5rem;margin-top:-1rem;">-->
  <!--                          <span class=""><?php echo e(translate('Just For You')); ?></span>-->
  <!--                      </h3>-->
                        <!-- Links -->
  ...
  <!--                      <?php $__currentLoopData = $featured_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>-->
  <!--                          <div class=" position-relative text-center has-transition hov-scale-img  border-right border-top border-bottom  <?php if($key == 0): ?> border-left <?php endif; ?>">-->
  <!--                              <a href="<?php echo e(route('products.category', $category->slug)); ?>" class="d-block">-->
  <!--                                  <img src="<?php echo e(uploaded_asset($category->banner)); ?>" class="lazyload h-130px mx-auto has-transition p-2 p-sm-4 mw-100"-->
  <!--                                      alt="<?php echo e($category->getTranslation('name')); ?>" onerror="this.onerror=null;this.src='<?php echo e(static_asset('assets/img/placeholder.jpg')); ?>';">-->
  <!--                              </a>-->
  ...
  star.addEventListener("click", () => {
    ...
    <script>
        $(document).ready(function(){
            ...
            $.post('<?php echo e(route('home.section.todays_deal')); ?>', {_token:'<?php echo e(csrf_token()); ?>'}, function(data){
            ...
            $.post('<?php echo e(route('home.section.newest_products')); ?>', {_token:'<?php echo e(csrf_token()); ?>'}, function(data){
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xm\htdocs\kolzo\kolzo\resources\views/frontend/index.blade.php ENDPATH**/ ?>