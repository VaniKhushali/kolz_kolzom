                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <?php endif; ?>
                             <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_support_tickets')): ?>
                                ...
                                ?>
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('customer_support_ticket.admin_index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['customer_support_ticket.admin_index', 'customer_support_ticket.admin_show'])); ?>">
                                        <span class="aiz-side-nav-text"><?php echo e(translate('Customers Ticket')); ?></span>
                           ...
                           <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_support_tickets')): ?>
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="<?php echo e(route('support_ticket.admin_index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['support_ticket.admin_index', 'support_ticket.admin_show'])); ?>">
                                        <span class="aiz-side-nav-text"><?php echo e(translate('Sellers Ticket')); ?></span>
                                        <?php if($support_ticket > 0): ?><span class="badge badge-info"><?php echo e($support_ticket); ?></span><?php endif; ?>
                                    </a>
                                </li>
                            <?php endif; ?>
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_all_support_tickets')): ?>
                                ...
                                ?>
                                <li class="aiz-side-nav-item"> 
                                    <a href="<?php echo e(route('support_tickets.admins_index')); ?>" class="aiz-side-nav-link <?php echo e(areActiveRoutes(['support_tickets.admins_index', 'support_ticket.admin_show'])); ?>">
...
<?php /**PATH D:\xm\htdocs\kolzo\kolzo\resources\views/backend/inc/admin_sidenav.blade.php ENDPATH**/ ?>