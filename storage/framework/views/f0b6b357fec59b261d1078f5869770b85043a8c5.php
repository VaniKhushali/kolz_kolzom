<?php if(get_setting('home_categories') != null): ?> 
    ...
    <?php $__currentLoopData = $home_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $category = get_single_category($value); ?>
        <?php if($category): ?>
                                ...
                                <div class="h-100 w-100 w-xl-auto position-relative hov-scale-img overflow-hidden">
                                    <div class="position-absolute h-100 w-100 overflow-hidden">
                                        <img src="<?php echo e(isset($category->coverImage->file_name) ? my_asset($category->coverImage->file_name) : static_asset('assets/img/placeholder.jpg')); ?>" 
                                            alt="<?php echo e($category->getTranslation('name')); ?>" class="img-fit h-100 has-transition"  
...
<?php /**PATH D:\xm\htdocs\kolzo\kolzo\resources\views/frontend/partials/home_categories_section.blade.php ENDPATH**/ ?>