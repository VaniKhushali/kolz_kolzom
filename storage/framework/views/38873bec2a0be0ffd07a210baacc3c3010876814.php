<!DOCTYPE html>
<?php if(get_session_language()->rtl == 1): ?>
...
<body>
    <!-- aiz-main-wrapper -->
    <div class="aiz-main-wrapper d-flex flex-column" style="background-color:#EEEEEE;">
    ...
    <script>
        ...
        $(".user-hover").on("mouseover", function (event) {
            $(".hover-user-top-menu").addClass('active');
        })
        .on("mouseout", function (event) {
            $(".hover-user-top-menu").removeClass('active');
        ...
        $(".aiz-user-top-menu-seller").on("mouseover", function (event) {
            $(".hover-user-top-menu-seller").addClass('active');
        })
        .on("mouseout", function (event) {
            $(".hover-user-top-menu-seller").removeClass('active');
        });

        $(".seller-hover").on("mouseover", function (event) {
            $(".hover-user-top-menu-seller").addClass('active');
        })
        .on("mouseout", function (event) {
            $(".hover-user-top-menu-seller").removeClass('active');
  ...
  <?php /**PATH D:\xm\htdocs\kolzo\kolzo\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>