<?php if(get_setting('best_selling') == 1 && count(get_best_selling_products(20)) > 0): ?>
    <section class="mb-2 mb-md-3 mt-2 mt-md-3">
        <div class="container">
            ...
            <!-- Product Section -->
            <div class="px-sm-3" style="margin-left:-3.5rem;margin-right:-3.5rem;">
                <div class="aiz-carousel sm-gutters-16 arrow-none" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
                    <?php $__currentLoopData = get_best_selling_products(20); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="carousel-box px-3 position-relative has-transition  border-right border-top border-bottom <?php if($key == 0): ?> border-left <?php endif; ?>">
...
<?php endif; ?>
<?php /**PATH D:\xm\htdocs\kolzo\kolzo\resources\views/frontend/partials/best_selling_section.blade.php ENDPATH**/ ?>