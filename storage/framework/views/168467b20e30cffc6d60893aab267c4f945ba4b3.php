<?php if(count($newest_products) > 0): ?>
    <section class="mb-2 mb-md-3 mt-2 mt-md-3">
        <div class="container">
            ...
            <!-- Products Section -->
            <div class="px-sm-3" style="margin-left:-3.5rem;margin-right:-4rem;">
...
<?php endif; ?><?php /**PATH D:\xm\htdocs\kolzo\kolzo\resources\views/frontend/partials/newest_products_section.blade.php ENDPATH**/ ?>