                        ...
                        <?php if(count($order->orderDetails) > 0): ?>
                            <tr>
                                ...
                                <td class="text-right pr-0">
                                    ...
                                    <!-- Invoice -->
                                    <a class="btn btn-soft-warning btn-icon btn-circle btn-sm hov-svg-white mt-2 mt-sm-0" href="<?php echo e(route('invoice.download', $order->id)); ?>" title="<?php echo e(translate('Download Invoice')); ?>">
...
<?php echo $__env->make('frontend.layouts.user_panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xm\htdocs\kolzo\kolzo\resources\views/frontend/user/purchase_history.blade.php ENDPATH**/ ?>